...
// wrapper to skip problematic files
...
export default defineConfig({
  ...
  server: (function() {
    ...
    // Allow opting in to aggressive dev asset cache for tunnel tests.
    // Default is disabled to prevent stale UI while developing.
    ...
    const middlewares = (app) => {
      ...
      // Set cache headers for dev responses.
      // Keep assets uncached by default so UI/code changes are always visible immediately.
      app.use((req, res, next) => {
        ...
        // HTML should never be cached during dev.
