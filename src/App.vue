                    ...
                    <nav class="actions">
                        ...
                        <div v-if="logged && isOnDashboard()" class="user-menu" ref="userMenu" @keyup.esc="closeMenu">
                            <transition name="btn-float">
                                <button :class="['user-btn', menuOpen ? 'open' : '']" @click="toggleMenu"
                                    :aria-expanded="menuOpen" aria-haspopup="true">
                                    <span class="avatar avatar-enhanced">
                                        <img v-if="avatarUrl && !avatarError" :src="avatarUrl" alt="avatar"
                                            class="top-avatar avatar-img" @error="onAvatarError" />
