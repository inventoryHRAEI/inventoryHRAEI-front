...
export const ROLES = {
  ...
  privileged: {
    id: 'privileged',
    label: 'Usuario Privilegiado',
    description: 'Puede crear, editar y descargar información. No puede eliminar ni gestionar usuarios.',
    color: '#8b5cf6',
    textColor: '#a78bfa',
    icon: '⭐',
    level: 2
  ...
  user: {
    ...
    description: 'Solo puede crear y consultar información como catálogo. No puede editar ni eliminar.',
    color: '#3b82f6',
    textColor: '#60a5fa',
    icon: '👤',
    level: 1
