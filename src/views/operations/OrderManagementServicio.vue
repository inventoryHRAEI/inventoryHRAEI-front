                ...
                <div v-if="showWizardModal" class="wizard-modal-overlay" @click.self="requestCloseWizard">
                    <div class="wizard-modal-container">
                        ...
                        <div class="wizard-modal-content">
                            <OpServicio v-if="showWizardModal && wizardType === 'servicio'" :key="`wizard-${wizardType}-${wizardRefreshKey}`" ref="wizardServicioRef"
...
const wizardServicioRef = ref(null)
...
async function handleWizardRefresh() {
    ...
    try {
        const target = wizardServicioRef.value
