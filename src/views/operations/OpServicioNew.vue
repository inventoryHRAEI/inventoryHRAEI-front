            ...
            <template #step-2>
                <div class="wizard-step">
                    <WizardStepCard title="Agregar Equipo" subtitle="Selecciona el tipo y completa la información"
                        ...
                        <InventoryRefinement
                            v-if="belongsToHospital === true && newItem.tipo && !isEditingItem"
                            :newItem="newItem"
...
function confirmAddWithWarnings() {
    if (pendingEquipment.value) {
        persistEquipmentItem(pendingEquipment.value, true)
...
function agregarItemBlanco() {
    ...
    form.equiposEntrada.push(blankItem)
    const newIndex = form.equiposEntrada.length - 1
