            ...
            if (versRes.ok) {
                ...
                const versItems = rows.map(v => {
                    ...
                    return {
                        ...
                        previewUrl: `/api/ops/resguardo/${encodeURIComponent(folio)}/versions/${encodeURIComponent(ver)}/preview`,
                        downloadUrl: `/api/ops/resguardo/${encodeURIComponent(folio)}/versions/${encodeURIComponent(ver)}/download`
                    }
                })
