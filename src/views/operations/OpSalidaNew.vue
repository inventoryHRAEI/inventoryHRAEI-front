<template>
  <div class="op-salida-new" :class="{ 'is-submitting': loading }">
    ...
    >
      ...
      <template #step-0>
        <div class="wizard-step">
          <WizardStepCard title="Datos del Solicitante" subtitle="Información básica de quien solicita la salida" icon-color="#22c55e">
            <template #icon>
            ...
            <div class="fields-grid">
              <ModernInput
                v-if="isFieldVisible('nombreSolicitante')"
              ...
              <ModernInput
                v-if="isFieldVisible('especialidad')"
          ...
          <WizardStepCard class="tall" title="Fecha y Horario" subtitle="Cuándo se realiza la salida" icon-color="#3b82f6">
            <template #icon>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      ...
      <template #step-1>
        <div class="wizard-step">
          <WizardStepCard class="tall" title="Motivo de Salida" subtitle="Razón por la cual sale el equipo" icon-color="#f59e0b">
            <template #icon>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                <circle cx="12" cy="12" r="10"/>
                <path d="M12 16v-4"/>
            ...
            <div class="fields-grid">
                    ...
                    <div v-if="showMotivoDropdown" class="motivo-dropdown">
                      ...
                      <div class="dropdown-options">
                        ...
                        >
                          ...
                          <svg 
                            v-if="form.motivoSalida === option.value"
                            class="option-check"
                            width="16" height="16" 
                            viewBox="0 0 24 24" 
                            fill="none" 
              ...
              <Transition name="slide-fade">
                <ModernInput
                  v-if="isFieldVisible('otroMotivo') && form.motivoSalida === 'otro'"
                  v-model="form.otroMotivo"
                  label="Especifica el motivo"
                  placeholder="Describe el motivo de salida"
                  class="span-full"
                />
              </Transition>

              <ModernInput
                v-if="isFieldVisible('descripcion')"
                v-model="form.descripcion"
                label="Descripción General"
                placeholder="Descripción detallada del motivo de salida..."
                multiline
                :rows="4"
                class="span-full"
              />
        ...
        <div class="wizard-step">
          ...
          >
            ...
            <div class="equipment-type-grid">
              <button
                v-for="tipo in tipoSalidaOptions"
                :key="tipo.value"
                type="button"
                class="type-card"
          ...
          <WizardStepCard 
            v-if="form.equiposSalida.length > 0"
            :title="`Equipos Agregados (${form.equiposSalida.length})`"
            subtitle="Lista de equipos que saldrán"
            icon-color="#10b981"
            collapsible
          >
            <template #icon>
            ...
            <div class="equipment-list">
              <TransitionGroup name="equipment-item">
                <div 
                  v-for="(item, index) in form.equiposSalida" 
                  :key="index"
      ...
      <template #step-3>
        <div class="wizard-step">
          <WizardStepCard title="Observaciones" subtitle="Notas adicionales sobre la salida" icon-color="#06b6d4">
            <template #icon>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <div class="fields-grid">
              <div class="observations-with-image span-full">
                <ModernInput
                  v-if="isFieldVisible('observaciones')"
              ...
              <ModernInput
                v-if="isFieldVisible('nombreIngeniero')"
      ...
      <template #summary>
        <LiveSummary 
          :items="summaryItems" 
          :equipment-count="form.equiposSalida.length"
        >
          <template #actions>
    ...
    <FormSchemaAdminPanel
        ...
        :system-fields="SALIDA_SYSTEM_FIELDS"
...
.btn-assign-other, .btn-assign-other-small {
  width: 100%;
  padding: 10px;
...
.btn-assign-other:hover, .btn-assign-other-small:hover {
...
.sig-badge.complete { background: rgba(34, 197, 94, 0.15); color: #4ade80; }
...
.btn-open-external, .btn-close-preview {
  padding: 8px;
  background: rgba(255, 255, 255, 0.1);
  border: none;
  border-radius: 8px;
...
.btn-open-external:hover, .btn-close-preview:hover {
