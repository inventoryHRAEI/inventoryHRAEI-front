  ...
  <ActionPanel class="dashboard-main">
    ...
    <div class="section-header">
      <div class="section-left">
        ...
        <p class="section-subtitle">Selecciona un módulo para comenzar a trabajar</p>
      </div>
...
const ROLE_LABELS = { user: 'Usuario', admin: 'Administrador', privileged: 'Privilegiado', usuario: 'Usuario', administrador: 'Administrador' }
