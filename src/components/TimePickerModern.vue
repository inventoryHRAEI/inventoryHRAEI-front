...
.time-input::-webkit-calendar-picker-indicator:hover { background-color: transparent; }

.time-picker-modern { position: relative; display: block; }
.time-icon {
  position: absolute;
  right: 6px;
  top: 50%;
...
.time-icon:disabled { opacity: 0.6; cursor: not-allowed; }

.time-input { padding-right: 50px; }
</style>